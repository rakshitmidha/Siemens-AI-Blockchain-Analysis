    ...
    return (
      <div className='row text-center'>
        <div className='col-md-12'>
         ...
         <h3>Correlation in Daily Change between Leocoin and Peercoin</h3>
        </div>
      </div>
    );
  }
        ...
        <div className='col-md-12'>
          <div id='user-select-dropdown' className='dropdown'>
            <button className='btn btn-default dropdown-toggle' type='button' id='user-select' data-toggle='dropdown' aria-haspopup='true' aria-expanded='true'>
              <span id='select-text'>Correlation in Daily Change between Leocoin and Peercoin</span> <span className='caret'></span>
            </button>
            <ul onClick={this.props.handleSelect} className='dropdown-menu' aria-labelledby='user-select'>
              <li><a href='javascript:void(0)' className='select current-selection' id='avg_temp_f'>Correlation in Daily Change between Leocoin and Peercoin</a></li>
